		...
		FilesAdded: function(up, files) {
			plupload.each(files, function(file) {
				...
				previewImage(file, function(imgsrc) { //进度条
					...
					if(filename.split("/")[1] == 'brand' || filename.split("/")[1] == 'topic' || filename.split("/")[1] == 'cate' || filename.split("/")[1] == 'symptoms' || filename.split("/")[1] == 'HomeBanner') { //shy
			...
			$(document).on('click', '.pic_list a.pic_delete', function() {
				...
				var filename = document.getElementById("dirname").value;
				if(filename.split("/")[1] == 'brand' || filename.split("/")[1] == 'topic' || filename.split("/")[1] == 'cate' || filename.split("/")[1] == 'symptoms' || filename.split("/")[1] == 'HomeBanner') {
					$("#selectfiles").show();
					$("#container>span").css("display", "block");
					$(".moxie-shim").css("display", "block");
					$("#postfiles").hide();

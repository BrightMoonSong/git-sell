			...
			resolve: {
				deps: ['$ocLazyLoad', function($ocLazyLoad) {
					return $ocLazyLoad.load([{
						...
						insertbefore: "#ng_load_plugins_before",
						files: [
							'/js/services/filecarm/FilecarmService.js',
							'/js/controllers/filecarm/FilecarmController.js'
						]
					}])
				}]
			}
			...
			resolve: {
				deps: ['$ocLazyLoad', function($ocLazyLoad) {
					return $ocLazyLoad.load([{
						...
						insertbefore: "#ng_load_plugins_before",
						files: [
							'/js/services/filecarm/FinancialService.js',
							'/js/controllers/filecarm/FinancialController.js'
						]
					}])
				}]
			}
			...
			resolve: {
				deps: ['$ocLazyLoad', function($ocLazyLoad) {
					return $ocLazyLoad.load([{
						...
						insertbefore: "#ng_load_plugins_before",
						files: [
							'/js/services/filecarm/PlatformDriverService.js',
							'/js/controllers/filecarm/PlatformDriverController.js'
						]
					}])
				}]
			}

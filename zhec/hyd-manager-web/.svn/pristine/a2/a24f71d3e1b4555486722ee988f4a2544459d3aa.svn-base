		...
		switch(url) {
			...
			case 'numberTwo.html': //二级菜单
				...
				$scope.find = function(currentPageNo, currentPaseSize) {
					...
					AuthFunctionService
						.twofind(currentPageNo, currentPaseSize, parentsId, names, scopeIdTwo)
						.then(function(result) {
			...
			case 'points.html': //功能点
				...
				$scope.find = function(currentPageNo, currentPaseSize) {
					...
					var parentsIds = $scope.parentIds;
					if(!parentsIds) {
						parentsIds = "";
					}
					var functionUrls = $scope.functionUrl;
					...
					AuthFunctionService
						.pointfind(currentPageNo, currentPaseSize, parentsIds, namedes, codes, scopeIdPoint)
						.then(function(result) {

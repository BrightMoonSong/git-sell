var constManagerLocation = "http://localhost:8099"; // 后台网站访问主机地址
var constMapiLocation = "http://localhost:8099/mapi"; // 后台接口配置
...
var imgPathCarModel = currentEnvironment + '/carmodel'; //字典管理   (车型管理)

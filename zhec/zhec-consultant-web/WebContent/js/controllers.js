...
function MainCtrl($rootScope, $scope, $timeout, constMessageCode, ngDialog, constConsultantLocation) {
    ...
    $rootScope.gotoIndex = function() {
        $timeout(function() {
            window.open(constConsultantLocation + "/index.html", "_self");
        }, 1000)
    }

 ...
 * 系统用户controller定义
 */
function PromotionOrdersController($scope, $http, $q, constPageSize, PromotionOrdersService, ngDialog) {
 ...
 * 显示订单详情
 */
function PromotionOrdersFormModalController($scope, PromotionOrdersService) {
...
angular
    .module('managerApp')
    .controller('PromotionOrdersController', PromotionOrdersController)

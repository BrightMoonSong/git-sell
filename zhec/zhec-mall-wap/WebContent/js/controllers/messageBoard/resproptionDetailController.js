 ...
 * 购物车controller定义
 */
function resproptionDetailController($scope,$rootScope, $q,$timeout,$stateParams, resproptionDetailService,ngDialog) {
...
app
	.controller('resproptionDetailController', resproptionDetailController)

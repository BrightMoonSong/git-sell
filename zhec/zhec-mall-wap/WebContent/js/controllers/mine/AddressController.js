function AddressController($scope, $rootScope, AddressService, ngDialog, $timeout) {
...
//				"height": $("#needs_head").height() + $(".edita_conter").height() + $(".edita_button").height() * 3
//			})
//			$(".swiper-container-fvp>.swiper-wrapper").css({
//				"height": $("#needs_head").height() + $(".edita_conter").height() + $(".edita_button").height() * 3
//			});
...
//					});
	...
	$scope.detail = function(addressId) {
		...
		//
		//			$timeout(function() {
		//					$(".swiper-container-fvp").css({"height":document.body.scrollHeight+'px'});
		//			console.log($(".swiper-container-fvp").height())
		//				}, 200);

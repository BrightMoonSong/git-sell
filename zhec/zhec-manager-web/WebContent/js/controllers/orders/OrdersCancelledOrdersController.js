 ...
 * 系统用户controller定义
 */
function OrdersCancelledOrdersController($scope, $q, constPageSize, OrdersCancelledOrdersService, ngDialog) {
...
angular
	.module('managerApp')
	.controller('OrdersCancelledOrdersController', OrdersCancelledOrdersController)

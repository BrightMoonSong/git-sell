 ...
 * 系统用户controller定义
 */
function OrdersUnpaidordersController($rootScope, $scope, $http, $q, constPageSize, OrdersUnpaidordersService, ngDialog) {
 ...
 * 弹出详情页面的controller定义
 */
function OrdersAllFormModalController($scope, OrdersUnpaidordersService) {
...
angular
	.module('managerApp')
	.controller('OrdersUnpaidordersController', OrdersUnpaidordersController)

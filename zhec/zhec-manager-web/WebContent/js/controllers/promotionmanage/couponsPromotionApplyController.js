 ...
 * 系统用户controller定义
 */
function couponsPromotionApplyController($scope, $q, constPageSize, couponsPromotionApplyService, ngDialog, promotionReminder) {
	...
	$scope.find = function(currentPageNo, currentPaseSize) {
		...
		//列表
		couponsPromotionApplyService.find(parmValue, minTime, maxTime, currentPaseSize, currentPageNo).then(
			function(result) {
	...
	$scope.openModal = function(n, res) {
		...
		if(n == 1) { //添加   修改  基本信息
			$scope.dialog = ngDialog.open({
				...
				controller: 'couponsPromotionApplyAddModalController',
				scope: $scope,
				width: 960
			});
		}
		if(n == 2) { //选择商品
			...
			$scope.dialog = ngDialog.open({
				...
				className: 'ngdialog-theme-default',
				controller: 'couponsOrdersPromotionApplySelectGoodsModalController',
				scope: $scope,
				width: 1160
			});
		}
		if(n == 3) { //选择分类
			...
			$scope.dialog = ngDialog.open({
				...
				className: 'ngdialog-theme-default',
				controller: 'couponsOrdersPromotionApplyClassifyModalController',
				scope: $scope,
				width: 1160
			});
		}
		if(n == 4) { //选择品牌
			...
			$scope.dialog = ngDialog.open({
				...
				className: 'ngdialog-theme-default',
				controller: 'couponsOrdersPromotionApplyBrandModalController',
				scope: $scope,
				width: 1160
			});
		}
		if(n == 5) { //提交审核
			...
			ngDialog.openConfirm({
				...
				couponsPromotionApplyService.commit(res.id).then(
					function(result) {
						$scope.loadData();
					});
			}, function(reason) {
 ...
 */
function couponsPromotionApplyAddModalController($scope, couponsPromotionApplyService, $rootScope) {
	...
	$scope.okModal = function() {
		//$scope.addData.quota>=$scope.addData.threshold
		if($scope.addData.quota >= $scope.addData.threshold) {
 ...
 */
function couponsOrdersPromotionApplySelectGoodsModalController($scope, $q, couponsPromotionApplyService, $rootScope, constPageSize) {
	//弹窗 分页
 ...
 */
function couponsOrdersPromotionApplyClassifyModalController($scope, couponsPromotionApplyService, $rootScope) {
 ...
 */
function couponsOrdersPromotionApplyBrandModalController($scope, couponsPromotionApplyService, $rootScope) {
	$scope.brandName = "";
...
angular
	.module('managerApp')
	.controller('couponsPromotionApplyController', couponsPromotionApplyController)
	.controller('couponsPromotionApplyAddModalController', couponsPromotionApplyAddModalController)
	.controller('couponsOrdersPromotionApplySelectGoodsModalController', couponsOrdersPromotionApplySelectGoodsModalController)
	.controller('couponsOrdersPromotionApplyClassifyModalController', couponsOrdersPromotionApplyClassifyModalController)
	.controller('couponsOrdersPromotionApplyBrandModalController', couponsOrdersPromotionApplyBrandModalController)
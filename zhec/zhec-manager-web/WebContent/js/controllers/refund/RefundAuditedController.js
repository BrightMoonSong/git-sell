 ...
 * 系统用户controller定义
 */
function RefundAuditedController($rootScope, $scope, $http, $q, constPageSize, RefundAuditedService, ngDialog) {
 ...
 * 弹出详情页面的controller定义
 */
function RefundAllFormModalController($rootScope, $scope, RefundAuditedService) {
	$scope.data = {};
...
angular
	.module('managerApp')
	.controller('RefundAuditedController', RefundAuditedController)

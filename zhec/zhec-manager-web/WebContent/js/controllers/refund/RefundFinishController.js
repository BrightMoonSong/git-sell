 ...
 * 系统用户controller定义
 */
function RefundFinishController($scope, $q, $rootScope, constPageSize, RefundFinishService, ngDialog) {
	...
	$scope.find = function(currentPageNo, currentPaseSize) {
		...
		RefundFinishService.find(memberName, orderSn, minTime, maxTime, currentPaseSize, currentPageNo).then(
			function(result) {
 ...
 * 弹出页面的controller定义
 */
function RefundAllFormModalController($scope, $rootScope, RefundFinishService) {
	$scope.data = {};
...
angular
	.module('managerApp')
	.controller('RefundFinishController', RefundFinishController)

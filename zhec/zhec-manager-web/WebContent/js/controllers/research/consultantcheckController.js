function consultantcheckController($rootScope, $scope, $http, $q, constPageSize, consultantcheckService, ngDialog) {

    $scope.find = function (currentPageNo, currentPaseSize) {
        var defer = $q.defer();
        consultantcheckService
...
function consultantModalController($rootScope, $scope, $http, $q, constPageSize, consultantcheckService, ngDialog){
...
angular
    .module('managerApp')
    .controller('consultantcheckController', consultantcheckController)

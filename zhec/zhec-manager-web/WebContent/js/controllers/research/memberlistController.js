function memberlistController($rootScope, $scope, $http, $q, constPageSize, memberlistService, ngDialog) {
...
function propertyModalController($rootScope, $scope, $http, $q, constPageSize, memberlistService, ngDialog){

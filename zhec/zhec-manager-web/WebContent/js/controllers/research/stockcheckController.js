function stockcheckController($rootScope, $scope, $http, $q, constPageSize, stockcheckService, ngDialog) {
...
function stockModalController($rootScope, $scope, $http, $q, constPageSize, stockcheckService, ngDialog){
